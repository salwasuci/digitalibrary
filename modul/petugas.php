...
$db = new Database();     // buat objek dari class
$pdo = $db->conn;         // ambil koneksi PDO-nya
?>
...
<head>
    ...
    gap: 15px;
    overflow-y: auto; /* Scroll otomatis jika konten lebih panjang */
    max-height: 100vh; /* Batas tinggi maksimal agar tidak melebihi layar */
}
...
<div class="sidebar">
    <div class="profile text-center">
        ...
        <h3><?= isset($_SESSION['username']) ? $_SESSION['username'] : 'Petugas'; ?></h3>
    </div>
...
<div class='content'>
    <div class='header'>Dashboard Petugas - Laporan Umum</div>
