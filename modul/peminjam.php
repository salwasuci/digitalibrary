...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <style>
        body {  overflow-x: hidden;  margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5; }
...
<a href="#top" class="scroll-top-btn">
 ...
 <!-- navigasi -->
    <div id="home">
<div class="navbar" style="display: flex; align-items: center; justify-content: space-between; padding: 10px 20px;">
    <!-- Logo Kiri -->
    <div class="logo">
        <img src="../asset/img/logo.png" style="height: 165px;">
    </div>

    <!-- Menu Navigasi Tengah -->
    <div class="center-menu" style="display: flex; gap: 15px;">
    <a href="#home" class="nav-link">Beranda</a>
    <a href="#tentang" class="nav-link">Tentang</a>
    <a href="#kategori" class="nav-link">Kategori</a>
    <a href="#galerry" class="nav-link">Galerry</a>
    <a href="#ulasan" class="nav-link">Ulasan</a>
    <a href="koleksi_outputan.php" class="nav-link">Koleksi Buku</a>
</div>

    <!-- Logout Kanan -->
    <div class="center-menu">
        <a href="../logout.php">
            <i class="bi bi-box-arrow-right" style="margin-right: 8px; color: #ff6600; font-size: 1.4rem;"></i> Logout
        </a>
    </div>
</div>
    <div class="welcome-section">
    <h1>Selamat Datang, <?= isset($_SESSION['username']) ? $_SESSION['username'] : 'peminjam'; ?>!</h1>
    <p>"Temukan buku favoritmu, pinjam dengan mudah, dan nikmati perjalanan membaca tanpa batas!"</p>
</div>
</div>
...
<div class="container-fluid fruite py-2">
    ...
    <a href="minjam.php?id=<?= $bk['BukuID'] ?>&user=<?= $_SESSION['UserID'] ?>" 
   class="btn border border-secondary rounded-pill px-2 py-1 text-orange fw-bold"
   style="font-size: 0.8rem; white-space: nowrap;">
   <i class="fa fa-book-open me-1 text-orange"></i> Pinjam Sekarang
</a>
<a href="ulasan_inputan.php?id=<?= $bk['BukuID'] ?>&user=<?= $_SESSION['UserID'] ?>" 
   class="btn border border-secondary rounded-pill px-2 py-1 text-orange fw-bold"
   style="font-size: 0.8rem; white-space: nowrap;">
   <i class="fa fa-book-open me-1 text-orange"></i> beri ulasan
</a>
</div>
...
<!-- konten2 -->
<section class="text-white d-flex align-items-center" style="min-height: 50vh; background: linear-gradient(to right, #1e2a38, #ff6f00); margin-left:-18px; width:105%; margin-top:15px;">
  <div class="container">
...
Koleksi dulu, pinjam nanti! Semua buku favoritmu bisa kamu simpan di sini dulu sebelum dibawa pulang dari NusaPustaka.
        ...
        <a href="koleksi_outputan.php" class="btn btn-orange text-white fw-semibold px-3 py-1 mt-2 shadow-sm">
...
<div class="text-center mb-4">
  ...
  <!-- footer -->
<footer class="text-white py-4" style="background-color: #334155; width:105%; margin-left:-18px; margin-top:10px;">
